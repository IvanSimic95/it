            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="header-box">
                        ...
                        <h2 class="new_prce" style="font-size: 35px;display: inline-block;">FREE!</h2>
                        <p>You save <span class="saveda"><b>$299</b> (90%)</span></p>
                    </div>
                    ...
                    <div id="order" class="form-container">
                        ...
                        <style>
#af-body-652309389{background-color: #f3f7fd;padding-top:0!important;}
</style>
