...
<form method="post" id="save-content-form">
    <div class="row">
        <div class="col-xl-6">
            ...
            <input class="form-control" id="inputTitle" name="title" type="text" value="<?php echo $row['title']; ?>" placeholder="Title of a Blog Post" />
            <label for="inputTitle">Title</label>
            </div>
        </div>
        <div class="col-xl-6">
            <div class="form-floating mb-3">
            <input class="form-control" id="inputShortlink" name="shortlink" value="<?php echo $row['shortlink']; ?>" type="text" placeholder="Shortlink (blog post URL)" />
            <label for="inputTitle">Shortlink</label>
            </div>
        </div>
    </div>
    <input type="hidden" id="postid" name="postid" value="<?php echo $row['id']; ?>">

				<textarea id="tinymce"><?php echo $row['text']; ?></textarea>
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function() {
         $('#save-content-form').on('submit', function(e) {
             ...
             $.ajax({
                 type: 'POST',
                 url: window.location.origin+'/admin/scripts/update.php',
                 data: data,
